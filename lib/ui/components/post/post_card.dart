...
class PostCard extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: isBox == true ? Colors.grey.withOpacity(0.1) : Colors.white,
              spreadRadius: 1,
              blurRadius: 10,
                    ...
                    children: List.generate(
                      ...
                      (index) => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: index == 4 ? AppStyle.primaryColor : Colors.white.withOpacity(0.8),
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildPostActions() {
    return Padding(
      ...
      child: Row(
        children: [
          Image.asset(AppAssets.likeIcon),
          const SizedBox(width: 6),
          Text('${post.likes}'),
          const SizedBox(width: 16),
          Image.asset(AppAssets.commentIcon),
          const SizedBox(width: 6),
          Text('${post.comments}'),
          const SizedBox(width: 16),
